...
export default function CreateAtCostClaimPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await atCostAPI.createClaim(payload);
  ...
  return (
    <AdminLayout>
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Buat Klaim At-Cost Baru</h1>
          <p className="text-gray-600 mt-1">
            Upload receipt dan buat klaim biaya transportasi & akomodasi
          </p>
        </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newItems = [...claimItems];
                        newItems[index].transport_cost = Number(e.target.value);
                        setClaimItems(newItems);
                      }}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md"
                      readOnly
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newItems = [...claimItems];
                        newItems[index].accommodation_cost = Number(e.target.value);
                        setClaimItems(newItems);
                      }}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md"
                      readOnly
